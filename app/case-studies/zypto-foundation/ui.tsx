...
const data: CaseStudyData = {
  ...
  gallery: {
    ...
    shots: [
      ...
      { image: `${base}/10.png`, alt: "Zypto Foundation — page", caption: "News Hub — live X feed with social aggregation." },
      { image: `${base}/11.png`, alt: "Zypto Foundation — page", caption: "Funding page — Marketing Effort Contributions and fee model." },
